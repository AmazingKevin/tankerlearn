...
void LevelScene::onEnterTransitionDidFinish()
{
    ...
    _num->setPosition(Vec2(1.0f,0.5f));
    _num->setAnchorPoint(Vec2(321,SCREEN_CY));
    this->addChild(_num);
...
{
    //LayerColor::initWithColor(Color4B(126,126,126,225));
    LayerColor * color = LayerColor::create(Color4B(126,126,126,225));
